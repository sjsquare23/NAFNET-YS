...
def create_lmdb_for_YS():
    folder_path = './datasets/YS/train/input_crops'
    lmdb_path = './datasets/YS/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/YS/train/gt_crops'
    lmdb_path = './datasets/YS/train/gt_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_YS_val():
    folder_path = './datasets/YS/val/input_crops'
    lmdb_path = './datasets/YS/val/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/YS/val/gt_crops'
    lmdb_path = './datasets/YS/val/gt_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_YS_test():
    folder_path = './datasets/YS/test/input_crops'
    lmdb_path = './datasets/YS/test/input_crops.lmdb'
